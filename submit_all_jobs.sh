...
# qsub -N pascalq -q pascalq -l select=1:ncpus=8:ngpus=2 -o ETAS_incomplete_25_output_seed_1.txt -e ETAS_incomplete_25_error_seed_1.txt -v data=ETAS_incomplete_10,tol=1e-3,model=attncnf,seed=1 job.sh;
...
# qsub -N pascalq -q pascalq -l select=1:ncpus=8:ngpus=1 -o SCEDC_25_output_seed_1.txt -e SCEDC_25_error_seed_1.txt -v data=SCEDC_25,tol=1e-3,model=attncnf,seed=1 job.sh;
