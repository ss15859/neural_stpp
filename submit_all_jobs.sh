...
qsub -N pascalq -q pascalq -l select=1:ncpus=8:ngpus=2 -o Japan_25_output_seed_0.txt -e Japan_25_error_seed_0.txt -v data=Japan_25,tol=1e-3,model=attncnf job.sh;
